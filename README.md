...
```
make start
PACKAGIST_TOKEN=99999999999999 make build-profile
make test-profile
```
...
This project will attempt to keep all of your Polaris and drupal core files up-to-date; the 
...
```
### How can I prevent downloading modules from polaris_site, that I do not need?

To prevent downloading a module, that Polaris provides but that you do not need, add a replace block to your composer.json:
